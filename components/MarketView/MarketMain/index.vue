...
<template>
  <div class="wrapper">
    <h2>
      <strong>热门藏品<span>( Hot )</span></strong>
    </h2>

    <div class="cards">
      <MarketViewMarketMainCard />
    </div>

    <h2><strong>热门链游-ETH</strong></h2>
      ...
      <figure class="article">
        ...
        <figcaption>
          ...
          <p>
            ...
            are better than that, as the all-new Flockheart’s Gamble Arcana item
            for Ogre Magi makes its grand debut.
          </p>
        </figcaption>
      </figure>
...
body {
  background: linear-gradient(to right, black 0%, #180019 70%, #400138 100%);
